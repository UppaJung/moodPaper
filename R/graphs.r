...
#> inmargins is a list of 2 float values: [pending]
...
grph.stackedFullProportionBarplot = function(mydata, filename = NULL, digits = 0, thiscolor = NULL,
						     useratiowithin = FALSE, uselegend = TRUE, legendoffset = 0.2, invert = FALSE, orderfirst=FALSE, showaxes = TRUE,
						     horizontal = TRUE, width = 4, height = 3, 
	...
	#> We order based on first column if asked to
	if (orderfirst) thisdata = thisdata[order(thisdata[,1]),]
